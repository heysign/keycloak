<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayWide=false>
  ...
  <head>
    ...
    <title>${msg("heysign-page-title")}</title>
    ...
    <script>
      ...
      function goToUrl(url) {
        console.log(url);
        if (url.includes("/auth/realms/heysign/account") ||
            url.includes("/auth/?client_id=web_app") ||
            url.includes("/auth/realms/heysign/login-actions/authenticate?client_id=web_app")
        ) {
          url = getHeySignHomeUrl();
      ...
      function displayAgreementRequiredErrorMessage() {
        ...
        // document.getElementById('register-validation-accept-agreement').classList.remove("heysign-content-hide");
        document.getElementById('register-validation-accept-agreement').classList.remove(
            "heysign-content-hide");
        // document.getElementById('register-button').classList.add("heysign-content-disabled");
      }
      ...
      function hideAgreementRequiredErrorMessage() {
        ...
        document.getElementById('register-validation-accept-agreement').classList.add(
            "heysign-content-hide");
        // document.getElementById('register-button').classList.remove("heysign-content-disabled");
      }
      ...
      function isAgreementRequired(updateAllAgreement, inputValidateAllFields) {
        ...
        if (isValueTrue(localServiceAgreement) && isValueTrue(localPrivacyAgreement)) {
          document.getElementById('register-agreement-section').classList.remove("heysign-error");
          document.getElementById('register-agreement-option-section').classList.remove(
              "heysign-error");
          // hideAgreementRequiredErrorMessage();
        } else {
          document.getElementById('register-agreement-section').classList.add("heysign-error");
      ...
      function allAgreementChecked() {
        ...
        document.getElementById('all-agreement-checkbox').classList.remove("heysign-content-hide");
      }

      function allAgreementUnchecked() {
        console.log('allAgreementUnchecked');
        document.getElementById('allAgreement').value = false;
        document.getElementById('all-agreement-checkbox').classList.add("heysign-content-hide");
      }
      ...
      function createSpanElement(text) {
        ...
        span.className = 'heysign-error-text';
        return span;
      }
  ...
  <div class="heysign-main">
    <div class="heysign-header">
      <div class="heysign-header-img" onclick="goToUrl('${url.homeUrl}')">

      </div>
    </div>
    <div class="heysign-content-wrapper">
