  ...
  <form id="kc-update-profile-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
    ...
    <div class="heysign-content heysign-content-register">
      ...
      <div id="register-agreement-section" class="register-agreement">
        ...
        <div id="register-agreement-option-section" class="register-agreement-select-options heysign-content-hide">
        ...
        <div id="register-validation-accept-agreement" class="register-validation-agreement heysign-content-hide">
