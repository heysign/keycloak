...
<div class="email-content" style="display: block; margin-left: auto; margin-right: auto; width: 600px; padding-top: 23px;">
  <div class="email-top-section" style="display: inline-block; vertical-align: top; border: solid 1px #efeff4; padding-top: 15px; width: 600px; background-color: #ffffff;">
    ...
    <div class="email-button-container width-130" style="margin: 40px 30px 30px 30px; display: inline-block; text-align: center; height: 40px; width: 130px;">
  ...
  <div class="document-email-footer-container" style="display: inline-block; vertical-align: top; width: 600px; height: auto; font-size: 13px; font-weight: 400; font-stretch: normal; font-style: normal; line-height: 1.46; letter-spacing: normal; color: #686d76; background-color: #ffffff; padding: 40px 0;">
